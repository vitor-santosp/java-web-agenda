...
<body>
	...
	<% String dataFormatada = fmt:formatDate value='${contatoAlteracao.datanascimento.time}' pattern='dd/MM/yyyy'/> ; %>
	<hr/>
	<form action="adicionaContato">
		...
		Data Nascimento: <cale:campoData id="dataNascimento" value=""/>
